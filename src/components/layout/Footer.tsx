        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/bazi" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  八字排盘
                </Link>
              </li>
              <li>
                <Link to="/ziwei" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  紫微斗数
                </Link>
              </li>
              <li>
